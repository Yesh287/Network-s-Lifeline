...
var nmap = __importStar(require("nmap.js"));
...
function runNmapScan(subnet) {
    return __awaiter(this, void 0, void 0, function () {
        var nmapScanner, report, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Attempting nmap scan on ".concat(subnet, "..."));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    nmapScanner = new nmap.NmapScan();
                    nmapScanner.runnmap = 'nmap'; // Ensure nmap is found in PATH
                    return [4 /*yield*/, nmapScanner.scan("-sn ".concat(subnet))];
                case 2:
                    report = _a.sent();
                    return [2 /*return*/, report];
                case 3:
                    error_1 = _a.sent();
                    console.warn('Nmap not found or permission denied, falling back to ping sweep:', error_1);
                    return [2 /*return*/, []];
...
function runPingSweep(subnet) {
    return __awaiter(this, void 0, void 0, function () {
        var hosts, ipParts, baseIp, i, ip, res, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Running ICMP ping sweep on ".concat(subnet, "... (This might take a while for large subnets)"));
                    hosts = [];
                    ...
                    _a.label = 1;
                case 1:
                    if (!(i <= 254)) return [3 /*break*/, 6];
                    ip = "".concat(baseIp, ".").concat(i);
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                ...
                case 3:
                    res = _a.sent();
                    if (res.alive) {
                        console.log("Device found: ".concat(ip, " (RTT: ").concat(res.avg, "ms)"));
